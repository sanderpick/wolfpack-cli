...
//
// Hoist `grr.api` from `wolfpack-api` module.
//
grr.api               = {};
grr.api.Client        = require('wolfpack-api').Client;
grr.api.Teams         = require('wolfpack-api').Teams;
grr.api.Users         = require('wolfpack-api').Users;
